            ...
            <tbody>
              ${events.map(event => `
                <tr>
                  ...
                  <td>${new Date(event.submitted_at).toLocaleDateString()}</td>
                  <td>
                    <button onclick="approveEvent('${event.id}')" class="btn btn-approve">Approve</button>
                    <button onclick="rejectEvent('${event.id}')" class="btn btn-reject">Reject</button>
                  </td>
                </tr>
              `).join('')}
            </tbody>

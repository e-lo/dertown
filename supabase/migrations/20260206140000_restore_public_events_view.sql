-- Restore public_events view so events are visible again.
-- Use only status = 'approved' so the view works regardless of whether
-- the 'cancelled' enum value has been committed in this session.
